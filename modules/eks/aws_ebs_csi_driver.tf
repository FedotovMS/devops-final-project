...
#   # Не вказуємо addon_version — EKS сам підбере сумісну з версією кластера
#   # addon_version = "v1.41.0-eksbuild.1"

#   # Щоб не ламати вже існуючу конфігурацію, якщо щось встановлено
...
resource "aws_eks_addon" "aws_ebs_csi_driver" {
  ...
  # Щоб не руйнувати конфіг, якщо щось вже є
  resolve_conflicts_on_update = "PRESERVE"
